...
export function BgmToggle({ src, title = 'Wedding BGM' }) {
  ...
  return (
    <div className="fixed right-4 top-4 z-50">
      ...
      />
      <button
        className="pressable flex h-11 w-11 items-center justify-center rounded-full border border-white/80 bg-white/90 text-wedding-ink shadow-[0_10px_30px_rgba(43,43,43,0.14)] hover:bg-white focus:outline-none focus:ring-2 focus:ring-wedding-champagne/30"
        type="button"
