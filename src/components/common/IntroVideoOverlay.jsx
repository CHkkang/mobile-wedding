 ...
 * @param {{videoId: string, greeting: string, durationMs: number, onFinish: () => void}} props Intro 설정과 종료 handler입니다.
 * @returns {JSX.Element | null} Intro overlay UI를 반환합니다.
 */
export function IntroVideoOverlay({ videoId, greeting, durationMs, onFinish }) {
  useEffect(() => {
